...
<table style='width:90%;'>
    <tbody>
        ...
        ?>
        <tr>
            <td colspan='10'> No hay productos en tu carrito.</td>
        </tr>
        <?php
        }
        ?>
        ...
        <tr bgcolor="#FCDC2F">
            <td align="right" colspan="10">Subtotal:  <span id="cart-subtotal"><?php echo number_format($subtotal,2);?></span> MXP</td>
            
        </tr>
        <tr bgcolor="#FCDC2F">
            <td align="right" colspan="10">Iva:  <span id="cart-iva"><?php echo number_format($iva,2);?></span> MXP</td>
            
        </tr>
        <tr bgcolor="#FCDC2F">
            <td align="right" colspan="10">Total:  <span id="cart-subtotal"><?php echo number_format($subtotal + $iva,2);?></span> MXP</td>
